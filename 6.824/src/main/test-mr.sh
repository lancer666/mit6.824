...
(cd /home/wangshiwei/mit_6.824/6.824/src/mrapps && go build $RACE -buildmode=plugin wc.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/mrapps && go build $RACE -buildmode=plugin indexer.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/mrapps && go build $RACE -buildmode=plugin mtiming.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/mrapps && go build $RACE -buildmode=plugin rtiming.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/mrapps && go build $RACE -buildmode=plugin crash.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/mrapps && go build $RACE -buildmode=plugin nocrash.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/main && go build $RACE mrmaster.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/main && go build $RACE mrworker.go) || exit 1
(cd /home/wangshiwei/mit_6.824/6.824/src/main && go build $RACE mrsequential.go) || exit 1
